...
FLAGS=-g -Wall 
LIBS=-lzip 
OBJS=$(OBJDIR)/bspatch.o $(OBJDIR)/main.o $(OBJDIR)/log.o $(OBJDIR)/fsarchive.o $(OBJDIR)/bsdiff.o $(OBJDIR)/settings.o 
EXEC=fsarchive
...
$(OBJDIR)/main.o: src/main.cpp src/settings.h src/fsarchive.h src/log.h $(OBJDIR)/__setup_obj_dir
	$(CPPC) $(FLAGS) ./src/main.cpp -c -o $@

$(OBJDIR)/log.o: src/log.cpp src/log.h $(OBJDIR)/__setup_obj_dir
	$(CPPC) $(FLAGS) ./src/log.cpp -c -o $@

$(OBJDIR)/fsarchive.o: src/fsarchive.cpp src/fsarchive.h src/settings.h src/utils.h \
 src/log.h src/bsdiff.h src/bspatch.h $(OBJDIR)/__setup_obj_dir
